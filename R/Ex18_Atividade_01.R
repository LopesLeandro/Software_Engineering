...
#"População é o conjunto de todos os elementos de uma determinada pesquisa.
...
''' # nolint
Prevenir a propagação de trinca de fadiga em estruturas de aviões é um importante elemento de segurança em aeronaves. Um estudo de engenharia para investigar a trinca de fadiga em 
n = 9 asas carregadas ciclicamente reportou os seguintes comprimentos (em mm) de trinca:
2,13	2,96	3,02	1,82	1,15	1,37	2,04	2,47	2,60
Crie um vetor com os valores e calcule a média e o desvio-padrão da amostra.
'''

# Language: r
# Path: R/Ex18_Atividade_02.R
#
# # Exemplo de como criar um vetor com os valores e calcular a média e o desvio-padrão da amostra

# # Criando um vetor com os valores
trinca <- c(2.13,2.96,3.02,1.82,1.15,1.37,2.04,2.47,2.60)
trinca
...
# crie um vetor com os valor de mean e sd
